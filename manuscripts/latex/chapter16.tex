...
like milk and water, viewing each other with kindly eyes.” (M 128)
\end{quotation}
...
principle of cordiality that creates love and respect, and conduces to
cohesion, to non-dispute, to concord, and to unity.” (M 48)
\end{quotation}
...
appreciative joy, and equanimity.{]} (A 3.65)
\end{quotation}
...
\item
  And if one does not penetrate higher, one will be reborn in the brahmā
  world.” (A 11.15)
\end{enumerate}
\end{quotation}
